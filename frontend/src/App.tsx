...
export default function App() {
  const { sendNewAnalysis, sendMessage, sendAnswer, sendPlanApproval, sendControl, contextUsage } =
    useWebSocket();
    ...
    <div className="h-screen flex flex-col bg-white">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <main className="flex-1 flex flex-col min-w-0">
          <ChatPanel onAnswer={sendAnswer} onPlanApproval={sendPlanApproval} onPromptSelect={handleSend} />
          <MessageInput
            onSend={handleSend}
