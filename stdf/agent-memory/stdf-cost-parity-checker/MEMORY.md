...
- [cost_parity_ai_cognitive_labor.md](./cost_parity_ai_cognitive_labor.md) — AI inference vs. knowledge workers: MET 2020-2021 at ~$0.28/CTE; $0.002 vs $17.50/CTE in 2024 (8,944x by 2025); R²=0.983; binding constraint is capability not cost; confidence 0.88
- [cost_parity_copper_electrification.md](./cost_parity_copper_electrification.md) — Copper demand 4-vector: Solar MET 2015-2016 (0.95), Wind MET 2013-2014 (0.92), BESS MET 2019-2020 (0.82), EV entry-level MET 2025-2026 (0.89); aggregate 0.89; EV full-market NOT_MET

- [cost_parity_sofc_swb.md](./cost_parity_sofc_swb.md) — SOFC vs SWB (Bloom Energy): LCOE NOT_MET 2031-2032 (commercial kill), marginal kill NOT_MET 2038-2042 (existential); SOFC stagnant at $3,500/kW post-2020; confidence 0.70
...
- [feedback_tony_marginal_cost_lcoe.md](./feedback_tony_marginal_cost_lcoe.md) — Tony rejects LCOE-only framing; always compute dual threshold (LCOE parity + marginal cost kill); LCOE is commercial displacement signal, marginal kill is existential endpoint
